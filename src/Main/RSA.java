...
public class RSA {
    ...
    public void genarateKEYS(String value) {
        ...
        try {
            ...
            obj.saveKeys(PUCLIC_KEY_FILE, rsaPublicKeySpec.getModulus(), rsaPublicKeySpec.getPublicExponent());
            obj.saveKeys(PRIVATE_KEY_FILE, rsaPrivateKeySpec.getModulus(), rsaPrivateKeySpec.getPrivateExponent());

            //Encrypt Data using Public Key
            byte[] encryptedData = obj.encryptData(value);

            //Descypt Data using Private Key
            obj.decryptData(encryptedData);
